        ...
        <div className='flex-grow w-20 p-12 flex flex-col items-center'>
          <div className='w-fit'>
            ...
            <p className='text-[20px] font-semibold w-fit'>
              Welcome, <span className='text-primary'>{person.name}</span>
            </p>
          </div>
        </div>
        <Card className='w-[48rem] overflow-y-auto h-full'>
          <h1 className='text-[32px] font-semibold pb-6'>{person.name}</h1>
          <div className='grid grid-cols-2 gap-4'>
            <div className='bg-[#F6F7FE] rounded-lg p-4 h-fit flex flex-col gap-2'>
              ...
              <div className='flex gap-2'>
                ...
                <p className='text-xs font-inter'>{person.organisation}</p>
              </div>
              <div className='flex gap-2'>
                <Location size='16' variant='Bold' color='#8E8E93' />
                <p className='text-xs font-inter'>{person.location}</p>
              </div>
              <div className='flex gap-2'>
            ...
            <div className='bg-[#F6F7FE] rounded-lg p-4 flex flex-col gap-4'>
              <div>
                ...
                <p className='text-xs font-inter'>{person.bio}</p>
              </div>
              <Separator />
              <div>
                <h2 className='text-base font-semibold'>Offer</h2>
                <p className='text-xs font-inter'>{person.offer}</p>
              </div>
            </div>
          </div>
        </Card>
