    ...
    <div className="flex flex-col justify-between items-center h-screen">
      ...
      <div className="flex items-center justify-center w-full h-full pb-12 xl:pb-32 px-6 xl:px-0 overflow-y-auto">
        ...
        <Card className="w-full md:w-[48rem] h-full p-6 pb-0 md:p-8 md:pb-0 flex flex-col">
          <div>
            <h2 className="text-[16px] md:text-[20px] font-semibold md:pt-4 pb-4 md:pb-6">
              Mutual Matches
            </h2>
            {mutuals.length === 0 ? (
              <div className="flex flex-col items-center justify-center w-full bg-[#F5F7FD] p-4 xl:p-7 mb-4 border-dashed border-2 border-[#6A45FF] rounded-lg">
                ...
                <Button
                  asChild
                  className="py-6 px-[4.75rem] w-28 font-semibold text-sm md:text-base mt-4"
                >
              ...
              <div className="flex gap-5 overflow-x-auto pb-4 -mr-6 md:-mr-8">
                {mutuals.map((person) => (
                  ...
                  >
                    ...
                    <p className="text-xs md:text-sm text-center w-full pt-2">
                      {person.name}
                    </p>
                  </Link>
                ))}
          ...
          <div className="h-full flex flex-col overflow-y-auto">
            <h2 className="text-[16px] md:text-[20px] font-semibold pt-4 pb-4 md:pb-6">
              ...
              <div className="flex flex-col gap-4 h-full overflow-y-auto">
                {nonMutuals.map((person) => (
                  ...
                  >
                    ...
                    <Button
                      asChild
                      className="text-sm py-5 px-7 md:text-base md:py-6 md:w-28 font-semibold"
                    >
