  ...
  return (
    <div className="flex flex-col justify-between items-center h-screen overflow-x-hidden xl:overflow-y-hidden">
      ...
      <div className="flex items-center justify-center w-full h-full pb-12 xl:pb-40 px-6 xl:px-0">
        ...
        <Card className="w-full md:w-[48rem] h-full py-6 pl-6 pr-0 pb-0 md:py-8 md:pl-8 md:pb-0 flex flex-col overflow-x-hidden">
          <div className="flex items-center mb-2 xl:mb-4 mx-auto pr-6 md:pr-8">
            <p className="text-2xl md:text-4xl font-semibold">Instagram</p>
          </div>

          <div className="relative my-4 mr-6 md:mr-8">
            <input
              type="text"
              value={search}
              onChange={handleChange}
              placeholder="Search..."
              className="text-sm md:text-base w-full p-3 md:p-4 pl-4 md:pl-5 pr-8 md:pr-12 bg-[#F6F7FE] rounded-lg focus:outline-none text-[#292D32]"
            />
            <div className="absolute right-4 top-1/2 transform -translate-y-1/2">
              <SearchNormal1 size="24" color="#292D32" className="size-4" />
            </div>
          </div>

          <div className="overflow-y-auto overflow-x-hidden mr-2">
              ...
              <div className="flex items-center gap-2 py-3" key={person.id}>
                ...
                {person.instagramLink ? (
                  <Link
                    href={person.instagramLink}
                    target="_blank"
                    className="text-end text-primary underline font-medium hidden md:block pr-6"
                    style={{ minWidth: "5rem" }}
                  >
                    {person.instagramLink.includes("instagram.com")
                      ? "@" +
                  ...
                  <p className="text-end hidden md:block pr-6">-</p>
                )}
              </div>
            ))}
          </div>
